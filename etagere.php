...
<?php include('menu.php'); ?>
  ...
  <div class="content">
    <button class="btn" onclick="toggleSection('listStock')">Liste matériels</button>
    <button class="btn" onclick="toggleSection('addStock')">Ajouter matériels </button>
...
<div id="addStock" class="section">
      ...
      <div id="ordinateurForm" class="stock-form">
        <form id="stockFormOrdinateur" action="ajout_etagere.php" method="POST">
  ...
  <div id="autresForm" class="stock-form" style="display:none;">
    <form id="stockFormAutres" action="ajout_etagere.php" method="POST">
